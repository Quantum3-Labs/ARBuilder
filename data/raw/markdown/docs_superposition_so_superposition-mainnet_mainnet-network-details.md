---
url: https://docs.superposition.so/superposition-mainnet/mainnet-network-details
title: ℹ️ Mainnet Network Details | Superposition
category: orbit_sdk
subcategory: docs
scraped_at: 2025-12-20T10:41:09.077794
---
...
`Ctrl``k`
  ...
  * [Bridge](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#bridge)
  * [Block Explorer](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#block-explorer)
  * [Network Details](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#network-details)
...
### 
[](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#bridge)
Bridge
[![Logo](https://docs.superposition.so/~gitbook/image?url=https%3A%2F%2Fframerusercontent.com%2Fimages%2FOMsQO5jXsmgCnZYCDzzyMxovM1E.svg&width=20&dpr=4&quality=100&sign=cab6351b&sv=2)Superposition - The Blockchain That Pays You To Use Itebridge.superposition.so](https://bridge.superposition.so)
Stargate Superposition Bridge
### 
[](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#block-explorer)
Block Explorer
[![Logo](https://docs.superposition.so/~gitbook/image?url=https%3A%2F%2Fexplorer.superposition.so%2Fassets%2Ffavicon%2Fandroid-chrome-192x192.png&width=20&dpr=4&quality=100&sign=315ecca2&sv=2)Superposition blockchain explorer - View Superposition stats | Blockscoutexplorer.superposition.so](https://explorer.superposition.so/)
Mainnet Explorer
### 
[](https://docs.superposition.so/superposition-mainnet/mainnet-network-details#network-details)
Network Details
Description
Details
Network Name
...
Config
[PreviousRoadmaps](https://docs.superposition.so/introduction/roadmaps)[Next🖥️ Using Superposition Mainnet](https://docs.superposition.so/superposition-mainnet/using-superposition-mainnet)
