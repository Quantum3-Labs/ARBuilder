---
url: https://docs.superposition.so/superposition-mainnet/developers
title: Developers | Superposition
category: orbit_sdk
subcategory: docs
scraped_at: 2025-12-20T10:41:21.078611
---
...
#  👷Developers
[Build on Superposition using Thirdweb](https://docs.superposition.so/superposition-mainnet/developers/build-on-superposition-using-thirdweb)[Free Startup Credits!](https://docs.superposition.so/superposition-mainnet/developers/free-startup-credits)[📈Incentives : Intent Based Yield Distribution](https://docs.superposition.so/superposition-mainnet/developers/incentives-intent-based-yield-distribution)
[PreviousUtility Mining](https://docs.superposition.so/superposition-mainnet/super-layer/utility-mining)[NextBuild on Superposition using Thirdweb](https://docs.superposition.so/superposition-mainnet/developers/build-on-superposition-using-thirdweb)
