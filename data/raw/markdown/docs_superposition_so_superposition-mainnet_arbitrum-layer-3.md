---
url: https://docs.superposition.so/superposition-mainnet/arbitrum-layer-3
title: Arbitrum Layer 3 | Superposition
category: orbit_sdk
subcategory: docs
scraped_at: 2025-12-20T10:41:23.730827
---
...
`Ctrl``k`
  ...
  * 🐈Superposition Mainnet
    ...
    * [3️⃣Arbitrum Layer 3](https://docs.superposition.so/superposition-mainnet/arbitrum-layer-3)
      * [✒️Stylus](https://docs.superposition.so/superposition-mainnet/arbitrum-layer-3/stylus)
      * [🪐Orbit Chains](https://docs.superposition.so/superposition-mainnet/arbitrum-layer-3/orbit-chains)
  * ✨Native dApps
...
[PreviousIncentives : Intent Based Yield Distribution](https://docs.superposition.so/superposition-mainnet/developers/incentives-intent-based-yield-distribution)[NextStylus](https://docs.superposition.so/superposition-mainnet/arbitrum-layer-3/stylus)
