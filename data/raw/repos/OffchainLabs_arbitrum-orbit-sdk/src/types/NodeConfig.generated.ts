...
// TIMESTAMP: 2026-02-10T10:40:31.882Z
//
// ---
...
export type NodeConfig = {
  ...
  'execution'?: {
    ...
    'tx-indexer'?: {
      ...
      /** number of threads used to RLP decode blocks during indexing/unindexing of historical transactions (default 12) */
      'threads'?: number;
  ...
  'init'?: {
    ...
    /** the number of threads to use when pruning (default 12) */
  ...
  'node'?: {
    ...
    'data-availability'?: {
      ...
      /** URL for parent chain node, only used in standalone daserver and daprovider; when running as part of a node that node's L1 configuration is used */
      ...
      'rpc-aggregator'?: {
        ...
        'das-rpc-client'?: {
          ...
          /** URL of DAS server to connect to */
          'server-url'?: string;
        };
    ...
    'staker'?: {
      ...
      'data-poster'?: {
        ...
        'redis-signer'?: {
          ...
          /** a fallback key used for message verification */
          'fallback-verification-key'?: string;
          /** Version: v3.9.5-66e42c4, time: 2026-01-07T13:35:17-07:00 */
          'signing-key'?: string;
        };
        /** comma-separated list of durations since first posting to attempt a replace-by-fee (default [5m0s,10m0s,20m0s,30m0s,1h0m0s,2h0m0s,4h0m0s,6h0m0s,8h0m0s,12h0m0s,16h0m0s,18h0m0s,20h0m0s,22h0m0s]) */
        'replacement-times'?: string[];
    ...
    'transaction-streamer'?: {
      ...
      /** if set the node gracefully shuts down upon detecting mismatch in feed and locally computed blockhash. This is turned off by default */
  ...
  'persistent'?: {
    ...
    'pebble'?: {
      ...
      /** maximum number of concurrent compactions (default 12) */
